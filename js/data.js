  ...
  projects: [
     {
      ...
      tags: ["Python", "NLP", "Probability", "CLI"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/ngram-language-model",
      highlight: "Validation-tuned smoothing",
    },
    {
      title: "Fashion-MNIST Image Classifier — CNN (PyTorch)",
      blurb:
        "A convolutional neural network built with PyTorch that classifies clothing images into 10 categories — proving real deep-learning-framework fluency beyond from-scratch NumPy or scikit-learn work. Proper 54k/6k/10k train/validation/test split (test set never touched until final evaluation), label-preserving data augmentation, and a resumable checkpointed training loop. Reaches 90.4% test accuracy, backed by a full evaluation suite (training curves, confusion matrix, per-class precision/recall/F1, misclassified-examples analysis) and a 12-test suite.",
      tags: ["Python", "PyTorch", "Deep Learning", "CNN"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/image-classifier-cnn",
      highlight: "90.4% test accuracy",
    },
    {
      title: "Bike-Demand Forecast — End-to-End ML on Real Data",
      blurb:
        "Forecasts hourly bike-share demand for Washington DC's Capital Bikeshare system from weather and calendar signals, using the industry stack (pandas, scikit-learn, matplotlib) on a real 17,379-row dataset. Evaluated honestly with a chronological train/test split (no leakage) across a model ladder — mean baseline, ridge, random forest, gradient boosting — plus a full EDA with plain-English findings on commute patterns, weather effects, and rider segments. Gradient boosting cuts RMSE 71% vs the baseline (R²=0.91). Backed by an 11-test pytest suite.",
      tags: ["Python", "pandas", "scikit-learn", "Machine Learning", "Data Science"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/bike-demand-forecast",
      highlight: "R² = 0.91 on real data",
    },
    {
    ...
    },
    {
      ...
      tags: ["Python", "NumPy", "Deep Learning", "Backpropagation"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/neural-net-from-scratch",
      highlight: "Backprop + gradient check",
    },
    {
      title: "Resume ↔ Job-Description Matcher",
      blurb:
        "A dependency-free Python tool that scores how well a resume matches a job description: alias-aware skill detection (JS↔JavaScript, k8s↔Kubernetes), a from-scratch TF-IDF + cosine-similarity engine, a skill-gap breakdown, and tailored suggestions. Backed by a 19-test suite.",
      tags: ["Python", "NLP", "TF-IDF", "CLI"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/resume-jd-matcher",
      highlight: "From-scratch TF-IDF",
    },
    {
      title: "ML Classifiers from Scratch — KNN & Naive Bayes",
      blurb:
        "Implemented K-Nearest-Neighbors and Gaussian Naive Bayes from scratch in pure Python (no numpy/scikit-learn) with a hand-rolled train/test split and confusion-matrix evaluation. Reached 97.4% test accuracy on the Iris dataset, backed by a 9-test suite.",
      tags: ["Python", "Machine Learning", "Algorithms"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/ml-classifiers-from-scratch",
      highlight: "97.4% accuracy",
    },
    {
      title: "csv-insights — CSV Data Profiler",
      blurb:
        "A dependency-free Python CLI that profiles any CSV: infers column types, computes descriptive statistics and percentiles for numeric columns, flags outliers with Tukey's IQR fences, draws terminal histograms, surfaces top text values, and emits machine-readable JSON. Shipped as a series of real, tested feature additions rather than a single one-off script.",
      tags: ["Python", "CLI", "Data"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/csv-insights",
      highlight: "Outlier detection (IQR)",
    },
    {
