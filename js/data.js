...
const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      blurb:
        "A dependency-free Python CLI that profiles any CSV: infers column types, reports missing/unique counts, computes numeric statistics, surfaces top text values, and emits machine-readable JSON.",
      tags: ["Python", "CLI", "Data"],
      link: "",
      repo: "https://github.com/ujjwalbhatiaa/csv-insights",
      highlight: "Pure stdlib",
    },
    {
